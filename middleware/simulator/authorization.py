...
from comm.bitcoin import get_tx_hash_for_unsigned_tx, get_signature_hash_for_p2sh_input, get_tx_version
...
def authorize_signature_and_get_message_to_sign(raw_tx_receipt, \
    ...
    try:
        ...
        if get_tx_version(raw_tx) not in _VALID_BTC_TX_VERSIONS:
