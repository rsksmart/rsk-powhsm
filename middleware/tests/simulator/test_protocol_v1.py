...
class TestHSM1ProtocolSimulator(TestCase):
    ...
    def test_get_pubkey(self, is_authorized_signing_path_mock):
        ...
        self.assertEqual(
            ...
            self.protocol.handle_request({ "version": 1, "command": "getPubKey", "keyId": "m/44'/0'/0'/0/0" }))
    ...
    def test_sign_ok(self, is_authorized_signing_path_mock, is_auth_requiring_path_mock):
        ...
        self.assertEqual(
            ...
            self.protocol.handle_request({ "version": 1, "command": "sign", "keyId": "m/44'/137'/0'/0/0", "message": "bb"*32 }))
    ...
    @patch('simulator.protocol_v1.is_auth_requiring_path')
    @patch('simulator.protocol_v1.is_authorized_signing_path')
    def test_sign_signing_wallet_keyget_error(self, is_authorized_signing_path_mock, is_auth_requiring_path_mock):
        is_authorized_signing_path_mock.return_value = True
        is_auth_requiring_path_mock.return_value = False
    ...
    @patch('simulator.protocol_v1.is_auth_requiring_path')
    @patch('simulator.protocol_v1.is_authorized_signing_path')
    def test_sign_signing_wallet_sign_error(self, is_authorized_signing_path_mock, is_auth_requiring_path_mock):
        is_authorized_signing_path_mock.return_value = True
        is_auth_requiring_path_mock.return_value = False
        the_key = Mock()
        self.wallet.get.return_value = the_key
    ...
    @patch('simulator.protocol_v1.is_auth_requiring_path')
    @patch('simulator.protocol_v1.is_authorized_signing_path')
    def test_sign_authrequiring_keyid(self, is_authorized_signing_path_mock, is_auth_requiring_path_mock) :
        is_authorized_signing_path_mock.return_value = True
        is_auth_requiring_path_mock.return_value = True

        self.assertEqual(
            { "errorcode": -2 },
            self.protocol.handle_request({ "version": 1, "command": "sign", "keyId": "m/44'/0'/0'/0/0", 
                                            "message": "aa"*32 }))
    ...
    @patch('simulator.protocol_v1.is_auth_requiring_path')
    @patch('simulator.protocol_v1.is_authorized_signing_path')
    def test_sign_message_invalid(self, is_authorized_signing_path_mock, is_auth_requiring_path_mock):
        self.assertEqual(
            { "errorcode": -2 },
            self.protocol.handle_request({ "version": 1, "command": "sign", "keyId": "m/44'/137'/0'/0/0", "message": 123 }))
