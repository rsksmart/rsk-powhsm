...
class TestAuthorization(TestCase):
    ...
    def test_invalid_receipt(self, get_signature_hash_for_p2sh_input_mock, get_tx_hash_for_unsigned_tx_mock, RskTrieMock, RskTransactionReceiptMock, get_tx_version_mock):
    ...
    def test_invalid_receipts_trie_proof(self, get_signature_hash_for_p2sh_input_mock, get_tx_hash_for_unsigned_tx_mock, RskTrieMock, RskTransactionReceiptMock, get_tx_version_mock):
    ...
    def test_receipts_trie_proof_no_leaf(self, get_signature_hash_for_p2sh_input_mock, get_tx_hash_for_unsigned_tx_mock, RskTrieMock, RskTransactionReceiptMock, get_tx_version_mock):
    ...
    def test_receipts_root_no_match(self, get_signature_hash_for_p2sh_input_mock, get_tx_hash_for_unsigned_tx_mock, RskTrieMock, RskTransactionReceiptMock, get_tx_version_mock):
    ...
    def test_receipts_leaf_value_no_match(self, get_signature_hash_for_p2sh_input_mock, get_tx_hash_for_unsigned_tx_mock, RskTrieMock, RskTransactionReceiptMock, get_tx_version_mock):
        trie_leaf = Mock(value_hash="the-receipt-hash")
    ...
    def test_invalid_transaction(self, get_signature_hash_for_p2sh_input_mock, get_tx_hash_for_unsigned_tx_mock, RskTrieMock, RskTransactionReceiptMock, get_tx_version_mock):
        trie_leaf = Mock(value_hash="the-receipt-hash")
        trie_root = Mock(**{"hash": self.blockchain_state.ancestor_receipts_root, "get_first_leaf.return_value": trie_leaf})
        receipt = Mock(hash=trie_leaf.value_hash)
        RskTrieMock.from_proof.return_value = trie_root
    ...
    def test_invalid_transaction_version(self, get_signature_hash_for_p2sh_input_mock, get_tx_hash_for_unsigned_tx_mock, RskTrieMock, RskTransactionReceiptMock, get_tx_version_mock):
        trie_leaf = Mock(value_hash="the-receipt-hash")
        trie_root = Mock(**{"hash": self.blockchain_state.ancestor_receipts_root, "get_first_leaf.return_value": trie_leaf})
        receipt = Mock(hash=trie_leaf.value_hash)
        RskTrieMock.from_proof.return_value = trie_root
    ...
    def test_no_logs(self, get_signature_hash_for_p2sh_input_mock, get_tx_hash_for_unsigned_tx_mock, RskTrieMock, RskTransactionReceiptMock, get_tx_version_mock):
        trie_leaf = Mock(value_hash="the-receipt-hash")
        trie_root = Mock(**{"hash": self.blockchain_state.ancestor_receipts_root, "get_first_leaf.return_value": trie_leaf})
        receipt = Mock(hash=trie_leaf.value_hash)
        RskTrieMock.from_proof.return_value = trie_root
    ...
    def test_no_log_matches(self, get_signature_hash_for_p2sh_input_mock, get_tx_hash_for_unsigned_tx_mock, RskTrieMock, RskTransactionReceiptMock, get_tx_version_mock):
        trie_leaf = Mock(value_hash="the-receipt-hash")
        trie_root = Mock(**{"hash": self.blockchain_state.ancestor_receipts_root, "get_first_leaf.return_value": trie_leaf})
        receipt = Mock(hash=trie_leaf.value_hash)
        RskTrieMock.from_proof.return_value = trie_root
    ...
    def test_authorization_ok(self, get_signature_hash_for_p2sh_input_mock, get_tx_hash_for_unsigned_tx_mock, RskTrieMock, RskTransactionReceiptMock, get_tx_version_mock):
        trie_leaf = Mock(value_hash="the-receipt-hash")
        trie_root = Mock(**{"hash": self.blockchain_state.ancestor_receipts_root, "get_first_leaf.return_value": trie_leaf})
