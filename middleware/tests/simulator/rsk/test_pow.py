...
class TestMergeMiningHash(TestCase):
    def test_coinbase_tx_extract_merge_mining_hash_ok_1(self):
        ...
        self.assertEqual("ddc052e0aa24959d2ff8a27d08dcfe96fefa98a93cb5018f93373a24001e5311", \
                         coinbase_tx_extract_merge_mining_hash(\
                            "000000000000010000a44ebb7a8bcef35aa7a849070f9dd026b6a8a576aab96ece2692fcbd215408301d6"+
                            "fbd7cfda6f6845ad9d6a19500000000000000002b6a2952534b424c4f434b3addc052e0aa24959d2ff8a2"+
                            "7d08dcfe96fefa98a93cb5018f93373a24001e5311d942ae07"))

    def test_coinbase_tx_extract_merge_mining_hash_ok_2(self):
        # Taken from https://explorer.rsk.co/block/2123456?__ctab=Mining
        self.assertEqual("3ed227d685e0a6cee102c6eb3bf60c0fac152c0632efd19533f2ab24002066c0", \
                         coinbase_tx_extract_merge_mining_hash(\
                            "00000000000000c0b8348e3bbc8df1d6619d2453d8cc7cbe1b7b44369232fb8d83ebdcfc87992989aa21a9"+
                            "ed7d8f27254fc6eb6bfa94986d7f343fb3e9e735e5167f15b15b9e2783ea75437908000000000000000000"+
                            "000000000000002c6a4c2952534b424c4f434b3a3ed227d685e0a6cee102c6eb3bf60c0fac152c0632efd1"+
                            "9533f2ab24002066c00000000000000000266a24b9e11b6d7d2854ea2c3c3fbf54009a4efa7d140c703bd4"+
                            "db3bb668a8500555bc6ac0b4e8c4e72a3c"))
...
class TestCoinbaseTxHash(TestCase):
    ...
    def test_coinbase_tx_hash_block_2270854(self):
        coinbase_tx = \
            "000000000000010030de89b6d016cf88a808cc2d0c06928530c82aeda"+\
...
class TestPoW(TestCase):
    ...
    def test_valid_pow_block_2270854(self):
        ...
        self.assertTrue(is_valid_merkle_proof(merkle_proof, merkle_root, coinbase_tx_hash))
